...
try{
		...
		if (update.connection == "open" || update.receivedPendingNotifications == "true") {
            ...
            console.log(color(`${themeemoji} GITHUB: sarKarji1 `,'magenta'))
...
XeonLft = await getBuffer(ppuser)
                ...
                let xeonName = num
                const xtime = moment.tz('pakistan/islamabad').format('HH:mm:ss')
	            const xdate = moment.tz('pakistan/islamabad').format('DD/MM/YYYY')
...
"sourceUrl": `${wagc}`}}})
                	...
                	const xeonbuffer = await getBuffer(ppuser)
                    const xeontime = moment.tz('pakistan/islamabad').format('HH:mm:ss')
	                const xeondate = moment.tz('pakistan/islamabad').format('DD/MM/YYYY')
                	let xeonName = num
